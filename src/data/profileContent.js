...
const profileContent = {
  ...
  projects: [
    ...
    },
    {
      ...
      caseStudy: {
        problem: "JavaScript physics engines struggle with complex collisions involving hundreds of bodies.",
        solution: "Ported a custom C++ physics engine using Emscripten, enabling predictable and fast simulation loops directly in the browser.",
        impact: "Adopted by two web-based puzzle games, achieving stable 60fps with 500+ active physics bodies.",
      },
      video: null,
    },
  ],

  /* ─── Current focus dynamically driven by tags ─── */
  ...
  posts: [
    ...
    },
    {
      ...
      date: "2025-08-22",
      tags: ["Exploring"],
      snippet: "Exploring WASI and the component model for building serverless functions that start in microseconds.",
      body: "## The Serverless Dream\nWe've been promised instant-start serverless functions for years. Containers are too heavy. V8 isolates are tightly bound to JavaScript. WebAssembly, paired with the WASI preview 2 standard, finally delivers a truly language-agnostic, secure, and fast sandbox.",
    },
  ],
  ...
  ideas: [
    {
      ...
      tags: ["Featured"],
      thumbnail: "/images/idea_radio.jpg",
    ...
    {
      title: "Local-First Issue Tracker",
      badge: "Developer Tools",
      description: "Jira is too slow. Linear is online-only. A lightning fast, local-first bug tracker built on SQLite.",
    },
    {
      ...
      tags: ["Featured"],
      thumbnail: "https://placehold.co/800x600/1A1A18/C4604A?text=Placeholder",
      description: "An interactive node-based editor for constructing complex regular expressions without losing your mind.",
    },
  ],
